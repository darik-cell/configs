...
map("n", "ЙЙ", markdown.send_prompt_buffer, { desc = "Send prompt buffer to agent terminal" })
...
map("n", "<leader>m", markdown.open_current_buffer_in_live_preview, { desc = "Open current markdown in live preview" })
